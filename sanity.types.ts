...
// Query: *[_type == "edition" && defined(year) && status != "upcoming"] | order(year desc) {    year,    theme,    themeHighlight,    dateStart,    dateEnd,    venueLine,    heroImage{ ..., "lqip": asset->metadata.lqip },    thumbImage{ ..., "lqip": asset->metadata.lqip }  }
