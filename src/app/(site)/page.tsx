...
import { ArtistsBanner } from '@/app/(site)/_components/ArtistsBanner'
import { FeaturedSpotlight } from '@/app/(site)/_components/FeaturedSpotlight'
import { homePage } from '@/app/(site)/page.recipe'
