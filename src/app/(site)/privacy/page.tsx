        ...
        <section className={`${shared.section} ${shared.sectionDark} ${styles.body}`}>
          <div className={shared.sectionInner}>
            <article className={styles.article}>
              <h2>Who we are</h2>
              <p>
                This site is operated by the organisers of {SITE_NAME} (Zilele Sculpturii
                București), a contemporary sculpture event based in Bucharest, Romania. Contact us
                at <a href="mailto:office@filialadesculptura.com">office@filialadesculptura.com</a>{' '}
                for any privacy question.
              </p>

              <h2>What we collect</h2>
              <p>
                Only what Google Analytics 4 collects when you accept cookies: anonymised IP
                address, page views, device and browser type, and approximate location (city level).
                We do <strong>not</strong> collect names, email addresses, or payment information
                through this site.
              </p>
              ...
              <ul>
                ...
                <li>
                  ...
                  visitors and sessions. Set only after you click <em>Accept</em>. Typical expiry:
                  up to two years.
                </li>
              </ul>
              <p>
              ...
              <h2>Your rights</h2>
              <p>
                Under GDPR you have the right to access, correct, delete, or export your data, and
