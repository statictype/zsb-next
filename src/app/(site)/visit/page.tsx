import { VenuesView } from '@/app/(site)/visit/_components/VenuesView'
import { VisitFaq } from '@/app/(site)/visit/_components/VisitFaq'
import { VisitSection } from '@/app/(site)/visit/_components/VisitSection'
