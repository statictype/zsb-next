...
export const editionCards: EditionCardData[] = [
  {
    year: 2025,
    theme: "#celălaltcorp",
    description: "The other body — exploring corporeality, presence, and the boundaries between self and sculpture.",
    href: "/editions/2025",
    variant: "sculpture",
    cardImage: {
  ...
  },
  {
    ...
    description: "The first Bucharest Sculpture Days, held entirely online during the pandemic. A digital beginning for a physical art form.",
    href: "#",
    variant: "online",
  },
];
